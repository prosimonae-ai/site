...
export const FURNITURE_PRESETS: FurniturePreset[] = [
  ...
  { name: 'PINNTORP table à rabat (dépliée)', brand: 'IKEA', width: 124, depth: 75, height: 73, material: 'wood', kind: 'table', model: 'ikea/pinntorp_table.glb', variant: 'dropleaf-open' },
  { name: 'PINNTORP table à rabat (repliée)', brand: 'IKEA', width: 69, depth: 75, height: 73, material: 'wood', kind: 'table', model: 'ikea/pinntorp_table.glb' },
  { name: 'PINNTORP chaise', brand: 'IKEA', width: 42, depth: 50, height: 90, material: 'wood', kind: 'chair', model: 'ikea/pinntorp_chaise.glb' },
  { name: 'LACK table basse', brand: 'IKEA', width: 90, depth: 55, height: 45, material: 'wood', kind: 'table', model: 'ikea/lack_basse.glb' },
  { name: 'YXSTABY support TV à roulettes', brand: 'IKEA', width: 137, depth: 60, height: 113, material: 'metal', kind: 'shelf', model: 'ikea/yxstaby.glb', matte: true },
  { name: 'RÅSKOG desserte', brand: 'IKEA', width: 45, depth: 35, height: 77, material: 'metal', kind: 'shelf', model: 'ikea/raskog.glb', matte: true },
  { name: 'RÅSKOG desserte + couvercle bois', brand: 'IKEA', width: 45, depth: 35, height: 77, material: 'metal', kind: 'shelf', model: 'ikea/raskog.glb', matte: true, variant: 'lid' },
  { name: 'BESTÅ caisson bas 60×42×38', brand: 'IKEA', width: 60, depth: 42, height: 38, material: 'wood', color: '#dccbb0', kind: 'cabinet' },
  { name: 'BESTÅ caisson haut 60×42×64', brand: 'IKEA', width: 60, depth: 42, height: 64, material: 'wood', color: '#dccbb0', kind: 'cabinet' },
  { name: 'DYVLINGE fauteuil pivotant', brand: 'IKEA', width: 63, depth: 71, height: 69, seatHeight: 43, material: 'fabric', color: '#1a1a1c', kind: 'sofa', variant: 'swivel', model: 'ikea/dyvlinge.glb' },
  ...
  { name: 'TV 55" (murale / sur support)', width: 123, depth: 6, height: 71, material: 'metal', kind: 'tv', variant: 'flat' },
  { name: 'TV 65" (murale / sur support)', width: 145, depth: 6, height: 83, material: 'metal', kind: 'tv', variant: 'flat' },
